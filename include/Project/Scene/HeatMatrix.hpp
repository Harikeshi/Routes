...
{
public:
    static std::vector<std::vector<int>> calculate(const std::vector<QPainterPath>& capsules, const QRectF& totalBBox, int gridH = 200, int gridW = 100)
    {
        std::vector<std::vector<int>> matrix;
        matrix.assign(gridH, std::vector<int>(gridW, 0));
