...
// Найти точку пересечения (если есть)
    inline bool
    intersection(const QPointF &A, const QPointF &B, const QPointF &C, const QPointF &D, QPointF &intersection) {
 ...
 */
    inline bool
    pointOnRayByAngle(const QPointF &O, const QPointF &u_unit, const QPointF &A, double radians, QPointF &Q) {
