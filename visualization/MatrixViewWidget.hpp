...
//     {
//         polyline_ = polyline;
//         auto matrix = buildMatrix(polyline_, stepSpin_->value(), radiusSpin_->value(), gridWSpin_->value(), gridHSpin_->value(), 1);
...
//         controls->addWidget(new QLabel("Step:"));
//         controls->addWidget(stepSpin_);
...
//             return buildMatrix(polyline_, step, radius, gridW, gridH, 1);
//         });
//         futureWatcher_->setFuture(future);
//     }

// private:
//     QSpinBox *radiusSpin_, *gridWSpin_, *gridHSpin_, *stepSpin_;
